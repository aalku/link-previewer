...
var fetchHTML = function (url, options) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, headers, noHeaders, timeout, response;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = options || {}, headers = _a.headers, noHeaders = _a.noHeaders, timeout = _a.timeout;
